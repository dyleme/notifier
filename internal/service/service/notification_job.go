...
type Notifier interface {
	Add(ctx context.Context, n domains2.SendingNotification) error
...
func (nj *NotifierJob) notifyEvent(ctx context.Context, ev *domains2.Event) error {
	...
	err := nj.notifier.Add(ctx, domains2.SendingNotification{
		EventID:          ev.ID,
		UserID:           ev.UserID,
		Message:          ev.Text,
