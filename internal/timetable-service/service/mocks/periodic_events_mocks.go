...
// Source: github.com/Dyleme/Notifier/internal/timetable-service/service (interfaces: PeriodicEventsRepository)
//
...
func (m *MockPeriodicEventsRepository) Add(arg0 context.Context, arg1 domains.PeriodicEvent) (domains.PeriodicEvent, error) {
	m.ctrl.T.Helper()
...
func (m *MockPeriodicEventsRepository) GetCurrentNotification(arg0 context.Context, arg1 int) (domains.PeriodicEventNotification, error) {
	m.ctrl.T.Helper()
...
func (m *MockPeriodicEventsRepository) ListNotificationsAtSendTime(arg0 context.Context, arg1 time.Time) ([]domains.PeriodicEventWithNotification, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListNotificationsAtSendTime", arg0, arg1)
	ret0, _ := ret[0].([]domains.PeriodicEventWithNotification)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPeriodicEventsRepository) Update(arg0 context.Context, arg1 domains.PeriodicEvent) (domains.PeriodicEvent, error) {
	m.ctrl.T.Helper()
...
func (m *MockPeriodicEventsRepository) UpdateNotification(arg0 context.Context, arg1 domains.PeriodicEventNotification) error {
	m.ctrl.T.Helper()
