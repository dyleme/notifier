...
UPDATE events 
    SET first_send_time = send_time,
        last_sended_time = 
            CASE WHEN sended 
                THEN send_time 
                ELSE TIMESTAMP '1970-01-01 00:00:00'
            END;
ALTER TABLE events ADD CONSTRAINT first_send_time_not_null CHECK (first_send_time IS NOT NULL),
...
ALTER TABLE events
    ADD CONSTRAINT notification_params_period_not_null CHECK (notification_params->>'period' != '0' and notification_params->>'params' != '{}');
